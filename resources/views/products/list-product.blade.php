        ...
        <div class="row">
            ...
            <div class="col-sm-9 padding-right">
                <div class="features_items">
                    ...
                    <ul>
                        <li><a class="{{ Request::get('price') == 1 ? 'active' : '' }}" href="{{ request()->fullUrlWithQuery(['price' => 1]) }}"> Dưới 100 </a></li>
                        <li><a class="{{ Request::get('price') == 2 ? 'active' : '' }}" href="{{ request()->fullUrlWithQuery(['price' => 2]) }}"> 100- 300 d </a></li>
                        <li><a class="{{ Request::get('price') == 3 ? 'active' : '' }}" href="{{ request()->fullUrlWithQuery(['price' => 3]) }}"> 300 - 500 d </a></li>
                        <li><a class="{{ Request::get('price') == 4 ? 'active' : '' }}" href="{{ request()->fullUrlWithQuery(['price' => 4]) }}"> 500 - 700 d </a></li>
                        <li><a class="{{ Request::get('price') == 5 ? 'active' : '' }}" href="{{ request()->fullUrlWithQuery(['price' => 5]) }}"> 700 - 900 d </a></li>
                    </ul>
                        ...
                        <div class="product-image-wrapper">
                            ...
                            <div class="single-products">
                                ...
                                @if($pro->sale['start_day'] <= now() && now() <=$pro->sale['end_day'])
                                    ...
                                    @endif
                                    @if ($pro['created_at'] >= now()->modify("-14 Days") && $pro['quantity'] != 0) <img src="images/new.png" class="new" alt=""> @endif
                            </div>
                        </div>
                    </div>
                    @endforeach
